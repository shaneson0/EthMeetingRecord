...
w3 = Web3(Web3.HTTPProvider("http://114.215.132.245:8545"))
...
class blockchainManager:
    ...
    # `date`,`time`,place, content, attList, title
    def make_record(self, contractinfo,  meetingRecord):
        tx_hash = contractinfo.functions.setContent(meetingRecord).transact(
            transaction={
                'from': w3.eth.accounts[0],
                'gas': 120000
            }
...
if __name__ == "__main__":
    ...
    maxIndex = blockmanager.getMaxBlockNum()
    print(maxIndex)
